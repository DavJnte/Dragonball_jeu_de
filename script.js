        ...
        if(gamePlaying) {
           ...
           var dice = Math.floor(Math.random() * 6) + 1;         
            ...
            if (dice !== 1) {
                //On cumul les points 
                roundScore += dice;
                document.querySelector('#current-' + activePlayer).textContent = roundScore;} else {
                nextPlayer();}}});}
...
//son echec
function soundfail(){let audio = new Audio('./Son&Musique/soundeffect/fail.mp3');audio.play();audio.volume = 0.5;}
//Son ambiance
function soundback(){let audio = new Audio('./Son&Musique/soundeffect/back_sound.mp4'); audio.play(); audio.volume = 0.1; audio.loop=true}
//Son degat
function damage(){let audio = new Audio('./Son&Musique/soundeffect/damage.mp3'); audio.play(); audio.volume = 0.3;}
//Son de victoire
function soundwin(){let audio = new Audio('./Son&Musique/soundeffect/win-sound-effect-no-copyright.mp3'); audio.play(); audio.volume = 0.3;}
