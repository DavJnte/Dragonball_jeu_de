...
// Fonction pour changer nom des joueurs
function editNames() {
    Nameplayer1 = prompt("Nom JOUEUR 1");
    Nameplayer2 = prompt("Nom JOUEUR 2");
  
    document.querySelector("h2.Player1")
        .innerHTML = Nameplayer1;
                              
    document.querySelector("h2.Player2")
        .innerHTML = Nameplayer2;
    nombloquer()
}
//Débloque le joueur 2
function joueur2debloquer(){
    let joueur2 = document.getElementById('select-player-2')
    joueur2.disabled=false
}
//Bloque les joueurs
function bloquer(){
    let charge1 = document.getElementById('chargerki1')
    charge1.disabled=true

    let charge2 = document.getElementById('chargerki2')
    charge2.disabled=true

    let uneattaque = document.getElementById('attaquer')
    uneattaque.disabled=true

    let unlancer = document.getElementById('lancer')
    unlancer.disabled=true 

    let joueur2 = document.getElementById('select-player-2')
    joueur2.disabled=true
}
//Debloque les boutons
function debloquer(){
    let charge1 = document.getElementById('chargerki1')
    charge1.disabled=false

    let charge2 = document.getElementById('chargerki2')
    charge2.disabled=false

    let uneattaque = document.getElementById('attaquer')
    uneattaque.disabled=false

    let unlancer = document.getElementById('lancer')
    unlancer.disabled=false
}

//Bloque nom joueur 
function nombloquer(){
    let rename = document.getElementById('Nameplayer')
